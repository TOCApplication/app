const quizData = [
  
    {
      ...
      questions: [
          { question: "What is the primary purpose of Finite Automata (FA)?", options: ["To simulate human-like intelligence", "To recognize patterns within strings or languages", "To optimize network systems", "To model complex systems"], answer: 1 },
          { question: "Which type of automaton has transitions determined by the current state and the input symbol, with only one possible transition for each combination?", options: ["Deterministic Finite Automata (DFA)", "Non-deterministic Finite Automata (NFA)", "Finite Automata with Epsilon Transitions", "Pushdown Automata (PDA)"], answer: 0 },
          { question: "What type of proof involves assuming the negation of the statement to be proven and deriving a contradiction?", options: ["Proof by Contradiction", "Proof by Counter example", "Inductive Proof", "Proof by Exhaustion"], answer: 0 },
          { question: "What is the main objective of minimization of DFAs?", options: ["To reduce memory usage", "To increase processing speed", "To reduce the number of states while preserving Language acceptance", "To improve the expressiveness of regular languages"], answer: 2 },
          { question: "What is the primary difference between an NFA and a DFA?", options: ["NFA have more states than DFAs", "NFAs have transitions without consuming input symbols", "NFAs cannot recognize regular languages", "NFAs cannot handle epsilon transitions"], answer: 1 }
      ]
  },
  {
      round: 2,
      info: "Welcome to Round 2",
      questions: [
